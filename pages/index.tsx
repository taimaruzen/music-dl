...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className={`min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 ${styles.page} ${geistSans.variable} ${geistMono.variable}`}>
        <main className={styles.main}>
          <div className="max-w-3xl mx-auto p-4">
            ...
            <div className={styles.ctas + " mb-6"}>
              <a
